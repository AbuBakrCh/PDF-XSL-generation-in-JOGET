...
public class GenerateXSL
{
    ...
    public void printXSLReport(HttpServletRequest request, HttpServletResponse response, Connection con) throws SQLException, IOException
    {

        ReportQueryHandler xslQueryHandler = new ReportQueryHandler();
        String refNo = request.getParameter("refNo");
        TreeMap<Integer, String[]> excelData = new TreeMap<Integer, String[]>();
        int i = 0;

        ResultSet rSet = xslQueryHandler.selectDataForXSL(refNo, con);
        while (rSet.next())
        {
